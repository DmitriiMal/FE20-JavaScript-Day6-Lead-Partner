...
let employees = [
  ...
  },
  {
    ...
    firstName: 'Jessica',
    lastName: 'Brown',
    emailAddress: 'jessica.brown@example.com',
  ...
  },
  {
    ...
    firstName: 'Brian',
    lastName: 'Anderson',
    emailAddress: 'brian.anderson@example.com',
    jobTitleName: 'Customer Support Specialist',
    salary: '50,000',
  },
  {
    userId: 'EMP008',
  ...
  },
  {
    ...
    firstName: 'Daniel',
    lastName: 'Thomas',
    emailAddress: 'daniel.thomas@example.com',
    jobTitleName: 'IT Support Technician',
    salary: '55,000',
  },
  {
    userId: 'EMP010',
    firstName: 'Amanda',
    lastName: 'White',
    emailAddress: 'amanda.white@example.com',
    jobTitleName: 'Project Manager',
    salary: '85,000',
  },
];

let employeesStr = JSON.stringify(employees);
let employeesObj = JSON.parse(employeesStr);
